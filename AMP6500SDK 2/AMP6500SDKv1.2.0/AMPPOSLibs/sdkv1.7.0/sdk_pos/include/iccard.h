...
int iccard_start_status_notify(int fd);
int iccard_wait_status_changed(int fd, int timeout);
int iccard_stop_status_notify(void);
 ...
 */
int iccard_get_slotno(int fd, uint32_t *slotno);
