...
#define LOGD(...)  if (0) \
    __android_log_print(ANDROID_LOG_DEBUG, "libnfc", __VA_ARGS__)
...
// Function:
//		PICC selection command, Type B, set T=CL
// Input:
//		fd     ----  device id, return from mif_open(...)
//		cid     ----- card identifier
//		fsdi   ----  Frame Size for PCD integer
...
#define CARRIER_OFF              0x00    // 关闭
#define CARRIER_ON               0x01    // 开启
