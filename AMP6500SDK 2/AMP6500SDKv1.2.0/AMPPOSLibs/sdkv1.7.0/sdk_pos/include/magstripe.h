...
#define CMD_MAG_GET_TRACKSET 				 0x01
#define CMD_MAG_SET_TRACKSET 				 0x02
#define CMD_MAG_READ_TIMEOUT_BLOCK    		 0x04
#define CMD_MAG_READ_TIMEOUT_BLOCK_CANCEL    0x05
#define CMD_MAG_IOC_IOCTL_CMD    			 0x06
...
int magstripe_swipe_cancel(int fd);
