...
public class ExpiryEntryManualActivity extends BaseActivity implements OnClickListener {

    private final String TAG = ExpiryEntryManualActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expiryentry_manual);
        ...
        screenTitle.setText("Enter Expiry Date");
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn00:
                ...
                break;
            case R.id.btnenter:
                String date = displayStr.toString();
                prepareAndSendData(date);
                break;
            case R.id.btnclr:
    ...
    private void prepareAndSendData(String date) {
        //TransObject.SetString(TransactionContract.CRTDATA_CARDEXPIRY, date);
